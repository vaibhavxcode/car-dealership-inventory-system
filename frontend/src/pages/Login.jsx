...
import { Lock, Mail, Car, AlertCircle, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-zinc-150">
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-zinc-400">
            ...
            <Link to="/register" className="text-zinc-850 hover:text-zinc-650 font-bold uppercase tracking-wider transition-colors ml-1">
              Register
            </Link>
          </p>
        </div>
